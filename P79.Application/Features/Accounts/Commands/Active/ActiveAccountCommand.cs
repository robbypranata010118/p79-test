...
{
    public class ActiveAccountCommand : IRequest<Response<Unit>>
    {
        public int Id { get; set; }
    }

    public class ActiveAccountCommandHandler : IRequestHandler<ActiveAccountCommand, Response<Unit>>
    {
        private readonly IGenericRepositoryAsync<Domain.Entities.Account> _genericRepository;
        private readonly IMapper _mapper;
        private readonly IMediator _mediator;

        public ActiveAccountCommandHandler(IGenericRepositoryAsync<Account> genericRepository, IMapper mapper, IMediator mediator)
        {
        ...
        public async Task<Response<Unit>> Handle(ActiveAccountCommand request, CancellationToken cancellationToken)
        {
